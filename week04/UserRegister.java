    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            while(true){
                ...
                String passsword_confirm = sc.nextLine();
                if(password.equals(passsword_confirm)){
                    break;
                }
                else{
                    System.out.println("================");
            ...
            System.out.println("ID는 " + user.get("userr") + " 입니다.");
            System.out.println("------------------");

            System.out.println("회원가입을 이어서 잔행하시겠습니까?\ny: 진행    n: 취소");
            System.out.println(">> ");
